...
Login = Button(root,text="Login",border=0,cursor='hand2',font=("Honk",11,"underline"),fg="black",command=log_in).place(x=1180, y=600)
...
Register_button = Button(root,cursor='hand2',text="Register",width=45,border=0,fg="black",bg="sky blue", font=("Honk",10),command=connect_database).place(x=1000, y=560,height=28)
